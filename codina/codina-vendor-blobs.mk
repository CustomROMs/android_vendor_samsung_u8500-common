...
# Audio
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/lib/hw/audio.primary_vendor.montblanc.so:system/lib/hw/audio.primary_vendor.montblanc.so \
...
#    $(LOCAL_PATH)/system/lib/libWVphoneAPI.so:system/lib/libWVphoneAPI.so

PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/vendor/libdrmmtkutil.so:system/vendor/lib/libdrmmtkutil.so \
    $(LOCAL_PATH)/system/lib/libwvdrm_L3.so:system/vendor/lib/libwvdrm_L3.so \
    $(LOCAL_PATH)/system/lib/libwvm.so:system/vendor/lib/libwvm.so \
    $(LOCAL_PATH)/system/lib/libWVStreamControlAPI_L3.so:system/vendor/lib/libWVStreamControlAPI_L3.so \
    $(LOCAL_PATH)/system/lib/drm/libdrmwvmplugin.so:system/vendor/lib/drm/libdrmwvmplugin.so \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/scripts1/00userinit:system/etc/init.d/00userinit \
    $(LOCAL_PATH)/system/scripts1/modules_list.txt:install/bin/modules_list.txt
endif

# bootanimation
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/bootanimation/480.zip:system/media/bootanimation.zip
...
# powerhal
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/autoload/999powerhal:system/etc/init.d/999powerhal

# video stop sound
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/sounds/VideoStop.ogg:system/media/audio/ui/VideoStop.ogg
