...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/lib/libsecril-client.so:janice/system/lib/libsecril-client.so
endif
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/system/bin/at_core:janice/system/bin/at_core \
    $(LOCAL_PATH)/system/bin/at_distributor:janice/system/bin/at_distributor \
    $(LOCAL_PATH)/system/bin/copsdaemon:janice/system/bin/copsdaemon \
    $(LOCAL_PATH)/system/bin/cspsa-server:janice/system/bin/cspsa-server \
    ...
    $(LOCAL_PATH)/system/bin/msa:janice/system/bin/msa \
...
# System STE Libs
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/lib/libatparser.so:janice/system/lib/libatparser.so \
    $(LOCAL_PATH)/system/lib/libbassapp.so:janice/system/lib/libbassapp.so \
    $(LOCAL_PATH)/system/lib/libcn.so:janice/system/lib/libcn.so \
    $(LOCAL_PATH)/system/lib/libcontrolcsc.so:janice/system/lib/libcontrolcsc.so \
    $(LOCAL_PATH)/system/lib/libcspsa.so:janice/system/lib/libcspsa.so \
    ...
    $(LOCAL_PATH)/system/lib/libexpat.so:janice/system/lib/libexpat.so \
    $(LOCAL_PATH)/system/lib/libpower.so:janice/system/lib/libpower.so \
    ...
    $(LOCAL_PATH)/system/lib/libsms_server.so:janice/system/lib/libsms_server.so \
    ...
    $(LOCAL_PATH)/system/lib/libtrace.so:janice/system/lib/libtrace.so \
    $(LOCAL_PATH)/system/lib/libstlport.so:janice/system/lib/libstlport.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/system/lib/libstagefrighthw.so:janice/system/lib/libstagefrighthw.so \
    ...
    $(LOCAL_PATH)/system/lib/libste_omxil-interface.so:janice/system/lib/libste_omxil-interface.so \
